...
def MC(A): 
      ...
      return [ A[0]^A[2]^A[3], A[0], A[1]^A[2], A[0]^A[2] ]
...
def fixed_input_state(input_num  ):
      ...
      col_1_num = int(int_str[0] + int_str[7] + int_str[10] + int_str[13], 2)
      col_2_num = int(int_str[1] + int_str[4] + int_str[11] + int_str[14], 2)
      col_3_num = int(int_str[2] + int_str[5] + int_str[8] + int_str[15], 2)
      col_4_num = int(int_str[3] + int_str[6] + int_str[9] + int_str[12], 2)
...
np.savetxt('Find_high_pro_SKINNY_8r.txt', Find_high_pro(T ,R, cells ), delimiter=' ')
...
print('T9:')
T = np.dot(T, T0)  
np.savetxt('Find_high_pro_SKINNY_9r.txt', Find_high_pro(T ,R, cells ), delimiter=' ')

print('T10:')
T = np.dot(T, T0)  
np.savetxt('Find_high_pro_SKINNY_10r.txt', Find_high_pro(T ,R, cells ), delimiter=' ')

print('T11:')
T = np.dot(T, T0)  
np.savetxt('Find_high_pro_SKINNY_11r.txt', Find_high_pro(T ,R, cells ), delimiter=' ')
